...
--}}
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('produit') }}'><i class='nav-icon fa fa-codepen'></i> Produits</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('catproduit') }}'><i class='nav-icon fa fa-th'></i> Categories</a></li>
