...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('catproduit') }}'><i class='nav-icon fa fa-question'></i> Categories</a></li>

<li class='nav-item'><a class='nav-link' href='{{ backpack_url('boitmsg') }}'><i class='nav-icon fa fa-question'></i> Boit de messages</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('client') }}'><i class='nav-icon fa fa-question'></i> Clients</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('cmd') }}'><i class='nav-icon fa fa-question'></i> Commandes </a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('rating') }}'><i class='nav-icon fa fa-question'></i> Ratings </a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('supp_lignecmd') }}'><i class='nav-icon fa fa-question'></i> Supp_lignecmds</a></li>
